...
- [01 把 skills 接进 DeepAgent](/knowledge-notes/docs/deep-agents/deep-agents-skills-teach-01-skill-structure/)
- [02 Skill 激活与渐进披露](/knowledge-notes/docs/deep-agents/deep-agents-skills-teach-02-progressive-disclosure/)
- [03 使用支持资源目录](/knowledge-notes/docs/deep-agents/deep-agents-skills-teach-03-supporting-resources/)
- [04 不同后端下使用 skills](/knowledge-notes/docs/deep-agents/deep-agents-skills-teach-04-backend-loading/)
- [05 权限、子 Agent 与排错](/knowledge-notes/docs/deep-agents/deep-agents-skills-teach-05-permissions-subagents-troubleshooting/)
- [06 综合案例：把 skills 串起来](/knowledge-notes/docs/deep-agents/deep-agents-skills-teach-06-comprehensive-case/)
- [07 多目录加载多个 Skills](/knowledge-notes/docs/deep-agents/deep-agents-skills-teach-07-multi-source-skills/)
