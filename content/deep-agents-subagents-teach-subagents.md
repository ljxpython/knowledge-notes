...
1. 先读 [00 覆盖清单与常用程度](/knowledge-notes/docs/deep-agents/deep-agents-subagents-teach-00-coverage-and-usage/)，别上来就扎进高级分支。
...
- [00 覆盖清单与常用程度](/knowledge-notes/docs/deep-agents/deep-agents-subagents-teach-00-coverage-and-usage/)
- [01 默认 general-purpose subagent](/knowledge-notes/docs/deep-agents/deep-agents-subagents-teach-01-default-general-purpose/)
- [02 自定义字典 subagent](/knowledge-notes/docs/deep-agents/deep-agents-subagents-teach-02-custom-subagent/)
- [03 runtime context 传播](/knowledge-notes/docs/deep-agents/deep-agents-subagents-teach-03-context-propagation/)
- [04 structured output](/knowledge-notes/docs/deep-agents/deep-agents-subagents-teach-04-structured-output/)
- [05 关闭同步 subagents](/knowledge-notes/docs/deep-agents/deep-agents-subagents-teach-05-disable-subagents/)
- [06 async subagents](/knowledge-notes/docs/deep-agents/deep-agents-subagents-teach-06-async-subagents/)
