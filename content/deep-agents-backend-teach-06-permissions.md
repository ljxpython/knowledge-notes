...
代码见 [`../06_permissions.py`](/knowledge-notes/examples/deep-agents/backend_teach/06_permissions.py)。
...
详细规则说明见 [03 CompositeBackend 讲义](/knowledge-notes/docs/deep-agents/deep-agents-backend-teach-03-composite-backend/#permissions文件工具的硬闸门)。
