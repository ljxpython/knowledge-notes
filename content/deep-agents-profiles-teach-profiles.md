...
- [01 HarnessProfile：追加模型专属提示](/knowledge-notes/docs/deep-agents/deep-agents-profiles-teach-01-harness-prompt-suffix/)
- [02 工具可见性与描述覆盖](/knowledge-notes/docs/deep-agents/deep-agents-profiles-teach-02-tool-visibility/)
- [03 ProviderProfile：模型构造参数](/knowledge-notes/docs/deep-agents/deep-agents-profiles-teach-03-provider-profile/)
- [04 HarnessProfileConfig：配置文件加载](/knowledge-notes/docs/deep-agents/deep-agents-profiles-teach-04-config-profile/)
- [05 综合案例：Provider + Harness 一起用](/knowledge-notes/docs/deep-agents/deep-agents-profiles-teach-05-comprehensive-case/)
